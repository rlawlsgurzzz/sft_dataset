...
# Gemini 요청 실패 시 수락될 때까지 같은 요청을 무한 재시도한다.
...
def run_teacher_until_accepted(
    *,
    input_path: Path,
    output_path: Path,
    trace_path: Path,
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run sequential SFT teacher generation batches and retry API requests until accepted."
    )
