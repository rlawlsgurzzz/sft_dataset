...
enemy_single_target_attack [18.2%(18%) / 10]
  enemy_alive [80.0%(80%) / 8]
    ...
    text_ally_target_but_enemy_skill [25.0%(25%) / 2]
...
ally_heal [12.7%(11%) / 7]
  ally_alive [85.7%(85%) / 6]
    ...
    text_enemy_target_but_ally_skill [33.3%(25%) / 2]
...
enemy_aoe_attack [14.5%(12%) / 8]
  enemy_alive [100.0%(100%) / 8]
    ...
    text_ally_target_but_enemy_skill [12.5%(25%) / 1]
